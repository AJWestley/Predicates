...
- - **[Adding Items](#adding-items-to-a-list)**
- - **[Deleting Items](#deleting-items-from-a-list)**
- - **[Checking for an Item](#checking-for-an-item-in-a-list)**
- - **[Size](#finding-the-length-of-a-list)**
- - **[Last Item](#last-item-of-a-list)**
- - **[Consecutive Duplicates](#removing-consecutive-duplicates)**
- - **[Range](#generating-a-sequential-list-from-a-range)**
- - **[Splitting Lists](#splitting-a-list)**
- - **[Shifting Lists](#shifting-a-list)**
- - **[Concatenating Lists](#concatenating-lists)**
- - **[Check Sorted](#check-a-list-is-sorted)**
- - **[Combining Sets](#combining-sets)**
- **[Binary Trees](#binary-trees-binary_treepl)**
- - **[Verifying Binary Tree](#verifying-a-binary-tree)**
- - **[Counting Leaves](#counting-the-leaves-in-a-tree)**
- - **[Traversing a Tree](#traversing-a-binary-tree)**
- **[Maths](#maths-mathspl)**
- - **[Prime Number](#checking-that-a-number-is-prime)**
- - **[GCD](#finding-the-greatest-common-divisor)**
- - **[Exponent](#exponents)**
- - **[Co-Primes](#co-primes)**
- - **[Integer Logarithm](#integer-logarithm)**
...
A specific value or index can be deleted from a list using `del` or `remove` respectively.

`del` and `remove` take 3 arguments:
- The item/index to delete
...
The `power` predicate can be used to calculate X^Y.

`power` takes 3 arguments:
- The base
- The exponent
- Output
